          ...
          >
            <motion.div
              ...
              style={{
                ...
                background:
                  "linear-gradient(to bottom, transparent 0%, var(--color-background) 92%)",
              }}
            ...
            <div className="sticky top-0 h-screen flex items-center justify-center pointer-events-none">
              <motion.div
                className="relative z-10 flex flex-col items-center gap-5 text-center px-4 pointer-events-auto"
              ...
              >
                <div className="relative">
                  <div
                    ...
                    style={{
                      background:
                        "radial-gradient(circle, oklch(0.62 0.09 240 / 0.6), transparent 70%)",
                      transform: "scale(1.8)",
                    }}
                  />
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    boxShadow: "0 4px 24px oklch(0.50 0.10 240 / 0.35)",
                  }}
                  whileHover={{
                    scale: 1.04,
                    boxShadow: "0 6px 32px oklch(0.50 0.10 240 / 0.5)",
                  }}
                  whileTap={{ scale: 0.97 }}
                >
