...
export class ImageNode extends DecoratorNode<JSX.Element> {
  ...
  static clone(node: ImageNode): ImageNode {
    return new ImageNode(node.__src, node.__altText, node.__maxWidth, {
      width: node.__width,
  ...
  static importDOM(): DOMConversionMap | null {
    const convertionFigure = (node: HTMLElement) => ({
  ...
  constructor(src: string, altText: string, maxWidth: number, options: ImageNodeOptions = {}) {
    super(options.key);
    this.__src = src;
    this.__altText = altText;
    this.__maxWidth = maxWidth;
    this.__width = options.width ?? 'inherit';
    this.__height = options.height ?? 'inherit';
    this.__showCaption = options.showCaption ?? false;
    this.__captionsEnabled = options.captionsEnabled || options.captionsEnabled === undefined;
    ...
    if (options.caption) {
      ...
      this.__caption = createEditor({
        ...
        nodes: [RootNode, TextNode, LineBreakNode, ParagraphNode, LinkNode, KeywordNode],
      });
    }
  }
