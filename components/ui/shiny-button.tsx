  ...
  return (
    <a
      className={cn(
        ...
        "bg-linear-to-br from-steel via-steel-dark to-steel-dark",
        "shadow-[0_0_0_1px_rgba(255,255,255,0.05),inset_0_1px_0_rgba(255,255,255,0.15)]",
        "hover:shadow-[0_0_28px_rgba(107,154,196,0.45),0_0_8px_rgba(139,181,217,0.3),inset_0_1px_0_rgba(255,255,255,0.2)]",
        "hover:border-steel-light/30",
        "hover:scale-[1.02]",
        "active:scale-[0.98]",
        className,
      )}
