...
const skills: SkillData[] = [
  ...
  },
  {
    ...
    color: "#858585",
    description:
      "Server components, app router, and full-stack React applications.",
    icon: (
  ...
  },
  {
    ...
    level: 93,
    color: "#06B6D4",
    description: "Rapid, utility-first styling with custom design systems.",
    icon: (
  ...
  },
  {
    ...
    level: 82,
    color: "#339933",
    description: "REST APIs, server-side logic, and backend services.",
    icon: (
  ...
  },
  {
    ...
    level: 85,
    color: "#F05032",
    description: "Version control, CI/CD pipelines, and deployment strategies.",
    icon: (
  ...
  },
  {
    ...
    level: 88,
    color: "#BB4B96",
    description: "Complex animations, gestures, and interactive experiences.",
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="#BB4B96">
